...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_IMAGES_VISUAL_IDENTIFIER_EXPANSION='󰉏'
  typeset -g POWERLEVEL9K_DIR_PHOTOS_VISUAL_IDENTIFIER_EXPANSION='󰉏'
  typeset -g POWERLEVEL9K_DIR_PICS_VISUAL_IDENTIFIER_EXPANSION='󰉏'
  typeset -g POWERLEVEL9K_DIR_WORK_VISUAL_IDENTIFIER_EXPANSION='󰉌'
  typeset -g POWERLEVEL9K_DIR_DEV_VISUAL_IDENTIFIER_EXPANSION='󰉌'
  typeset -g POWERLEVEL9K_DIR_DL_VISUAL_IDENTIFIER_EXPANSION='󰉍'
  typeset -g POWERLEVEL9K_DIR_DOC_VISUAL_IDENTIFIER_EXPANSION='󰉌'
  ...
  function my_git_formatter() {
    ...
    # *42 if have stashes.
    (( VCS_STATUS_STASHES        )) && res+=" ${clean}󰠘${VCS_STATUS_STASHES}"
    # 'merge' if the repo is in an unusual state.
    [[ -n $VCS_STATUS_ACTION     ]] && res+=" ${conflicted}${VCS_STATUS_ACTION}"
    # ~42 if have merge conflicts.
    (( VCS_STATUS_NUM_CONFLICTED )) && res+=" ${conflicted}󰋮${VCS_STATUS_NUM_CONFLICTED}"
